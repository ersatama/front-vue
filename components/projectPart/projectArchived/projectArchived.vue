<template>
    <div class="block-body-right" >
        <modal-detail :show="showDetail" @closeModal="showDetail = false">
            <project-archived-detail :data="data" v-if="data" @closeModal="showDetail = false"></project-archived-detail>
        </modal-detail>
...
import ProjectArchivedDetail from "./projectArchivedDetail.vue";
