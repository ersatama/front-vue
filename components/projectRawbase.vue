  ...
  <div class="block-body-content-table">
      ...
      <div class="block-body-content-table-header">
          <div class="block-body-content-table-tr" onselectstart="return false">
              ...
              <div class="block-body-content-table-item block-body-content-table-item-name" @click="setOrderBy('display_name')">
      ...
      <div class="block-body-content-table-body">
          <div class="block-body-content-table-tr" v-for="(rawbase, key) in rawbases" :key="key" @click="checkRawbase(rawbase.id)">
              ...
              <div class="block-body-content-table-item block-body-content-table-item-name">{{ rawbase.display_name }}</div>
...
import RawbaseFilter from "./rawbaseFilter.vue";
import RawReportFilter from "./rawReportFilter.vue";

export default {
    name: "projectRawbase",
    components: {RawReportFilter, RawbaseFilter, ModalBox},
    props: ['portalProject'],
    data() {
        return {
            rawbases: [],
